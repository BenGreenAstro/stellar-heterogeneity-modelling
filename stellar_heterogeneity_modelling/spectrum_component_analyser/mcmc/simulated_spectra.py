...
def random_component(max_weight : float, spec_grid : spectral_grid) -> spectral_component:
...
def get_random_simulated_spectrum(number_of_components : int, spec_grid : spectral_grid) -> Tuple[list[spectral_component], list[phoenix_spectrum], spectrum]:
    components : list[spectral_component] = []
    component_spectra : list[phoenix_spectrum] = []
    total_weight_left = 1

    for i in range(number_of_components):
        c = random_component(total_weight_left, spec_grid)
